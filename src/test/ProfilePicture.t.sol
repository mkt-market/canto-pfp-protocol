...
contract ProfilePictureTest is DSTest {
    ...
    function setUp() public {
        ...
        pfp = ProfilePicture(new ProfilePicture(address(mockCidNFT), "SubprotocolName"));
        vm.stopPrank();
    }
    ...
    function testCannotMintNFTNotOwnedByCaller() public {
        ...
        vm.expectRevert(abi.encodeWithSelector(ProfilePicture.PFPNotOwnedByCaller.selector, user2, mockERC721, nftId));
